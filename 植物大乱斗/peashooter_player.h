...
extern std::vector<Bullet*> bullet_list; // 全局子弹列表
...
private:
	const float speed_pea = 0.75f;		// 普通攻击豌豆子弹的速度
	const float speed_pea_ex = 1.5f;	// 特殊攻击豌豆子弹的速度
	const int attack_ex_duration = 2500;// 特殊攻击持续时间
	Timer timer_attack_ex;				// 特殊攻击计时器
	Timer timer_spwan_pea_ex;			// 豌豆子弹发射计时器
