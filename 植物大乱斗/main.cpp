...
IMAGE img_buff_icon_recover;						// 补给 Buff 图标
IMAGE img_buff_icon_blue;						// 补给 Buff 图标
...
IMAGE img_peashooter_selector_background_left;	// 选角界面朝向左的婉豆射手背景图片
IMAGE img_peashooter_selector_background_right; // 选角界面朝向右的婉豆射手背景图片
...
IMAGE img_nut_selector_background_left;		// 选角界面朝向左的坚果背景图片
IMAGE img_nut_selector_background_right;		// 选角界面朝向右的坚果背景图片
IMAGE img_gloomshroom_selector_background_left;	// 选角界面朝向左的暗影蘑菇背景图片
IMAGE img_gloomshroom_selector_background_right;	// 选角界面朝向右的暗影蘑菇背景图片
...
Atlas atlas_peashooter_idle_left;				// 婉豆射手朝向左的默认动画图集
Atlas atlas_peashooter_idle_right;				// 婉豆射手朝向右的默认动画图集
Atlas atlas_peashooter_run_left;				// 婉豆射手朝向左的奔跑动画图集
Atlas atlas_peashooter_run_right;				// 婉豆射手朝向右的奔跑动画图集
Atlas atlas_peashooter_attack_ex_left;			// 婉豆射手朝向左的特殊攻击动画图集
Atlas atlas_peashooter_attack_ex_right;			// 婉豆射手朝向右的特殊攻击动画图集
Atlas atlas_peashooter_die_left;				// 婉豆射手朝向左的死亡动画图集
Atlas atlas_peashooter_die_right;				// 婉豆射手朝向右的死亡动画图集
...
Atlas atlas_nut_idle_left;						// 坚果朝向左的默认动画图集
Atlas atlas_nut_idle_right;						// 坚果朝向右的默认动画图集
Atlas atlas_nut_run_left;						// 坚果朝向左的奔跑动画图集
Atlas atlas_nut_run_right;						// 坚果朝向右的奔跑动画图集
Atlas atlas_nut_attack_ex_left;					// 坚果朝向左的特殊攻击动画图集
Atlas atlas_nut_attack_ex_right;				// 坚果朝向右的特殊攻击动画图集
Atlas atlas_nut_die_left;						// 坚果朝向左的破碎动画图集
Atlas atlas_nut_die_right;						// 坚果朝向右的破碎动画图集

Atlas atlas_gloomshroom_idle_left;				// 暗影蘑菇朝向左的默认动画图集
Atlas atlas_gloomshroom_idle_right;				// 暗影蘑菇朝向右的默认动画图集
Atlas atlas_gloomshroom_run_left;				// 暗影蘑菇朝向左的奔跑动画图集
Atlas atlas_gloomshroom_run_right;				// 暗影蘑菇朝向右的奔跑动画图集
Atlas atlas_gloomshroom_attack_ex_left;			// 暗影蘑菇朝向左的特殊攻击动画图集
Atlas atlas_gloomshroom_attack_ex_right;		// 暗影蘑菇朝向右的特殊攻击动画图集
Atlas atlas_gloomshroom_die_left;				// 暗影蘑菇朝向左的死亡动画图集
Atlas atlas_gloomshroom_die_right;				// 暗影蘑菇朝向右的死亡动画图集
...
Atlas atlas_nut_explode;						// 坚果爆炸动画图集
Atlas atlas_gloomshroom_bubbles;				// 暗影蘑菇爆炸动画图集
Atlas atlas_gloomshroom_ex_bubbles;				// 暗影蘑菇高级爆炸动画图集
...
IMAGE img_avatar_peashooter;					// 婉豆射手头像图片
IMAGE img_avatar_sunflower;						// 龙日葵头像图片
IMAGE img_avatar_nut;							// 坚果头像图片
IMAGE img_avatar_gloomshroom;					// 暗影蘑菇头像图片
...
Camera main_camera;
std::vector<Platform> platforms_list;	// 平台列表
std::vector<Bullet*> bullet_list;	// 子弹列表

Player* player_1 = nullptr;	// 玩家 1
Player* player_2 = nullptr;	// 玩家 2
